...
function normWebHref(raw?: string): string | undefined {
  ...
  // add https if missing protocol (only for absolute-like values)
        ...
        <div className="mx-auto" style={{ maxWidth: 980 }}>
          ...
          <div className="row g-4 g-lg-5">
            {branches.map((b) => {
              ...
              // ✅ Si `web` empieza con "/", la hacemos tenant-aware; si no, usamos la normalización https://
              const webHref = web?.startsWith('/')
                ? withTenant(web)
                : normWebHref(web || undefined);
                      ...
                      {web && (
                        <div className="mb-0">
                          ...
                          {webHref ? (
                            <a
                              href={webHref}
                              target={webHref.startsWith('http') ? '_blank' : undefined}
                              rel={webHref.startsWith('http') ? 'noopener noreferrer' : undefined}
